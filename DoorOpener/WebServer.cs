        ...
        private void ProcessRequest(HttpListenerContext context)
        {
            ...
            switch (request.HttpMethod)
            {
                case "GET":
                    ...
                    if (url[0] == "/stylesheet.css")
                    {
                        response.ContentType = "text/css";
                        responseString = ReplaceMessage(Resources.GetString(Resources.StringResources.stylesheet), "");
                    ...
                    else
                    {
                        ...
                        //Add the footer to the website
                        websitehtml += Resources.GetString(Resources.StringResources.main_footer);

                        OutPutResponse(response, websitehtml);
                    }
                    break;
